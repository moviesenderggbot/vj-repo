...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002027228432'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1913676476').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002138175233').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# auth_channel means force subscribe channel.
auth_channel = environ.get('AUTH_CHANNEL', '-1002174170758') # give your force subscribe channel id here else leave it blank
auth_grp = environ.get('AUTH_GROUP', '-1002174170758') # give your force subscribe group id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002222992298')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002174170758')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MX_FLIX')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/how_to_open_moive_link/2')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/how_to_open_moive_link/3')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'xyz_problem_bot') # Support Chat Link Without https:// or @
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://mymade-2c0a00a2a710.herokuapp.com/")
